...
TITLE = "Ternary search (iterative) results: Execution Time analysis" ##TITLE##
...
FIT_LIMIT =1e-20
fit f(x) "data/tsearch_it_time.dat"  u 1:2 via a,b

#print a,b


plot "data/tsearch_it_time.dat"   u 1:2   t"" w lp lt 1 lc 0 pt 1 ps 1, \
...
!mv figure-gnuplot-crop.pdf tsearch_it_time.pdf ##FIGNAMEPDF##
